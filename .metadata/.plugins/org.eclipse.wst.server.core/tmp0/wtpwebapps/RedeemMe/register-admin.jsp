...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <title>Add Admin | redeemMe</title>
  ...
  <body class="  ">
           ...
           <div class="row">
               <div class="col-sm-12">
                   <div class="card">
                       ...
                       <div class="card-body">
                           <form id="myForm" action="AddAdminController" method="post" enctype="multipart/form-data">
                               <div class="row">
                                   <div class="col-md-12">
                                       <div class="form-group">
                                           <label>First Name </label>
                                           <input type="text" name="first-name" class="form-control" placeholder="Enter your first name" required pattern="[A-Za-z ]+" title="Please enter a valid name">
                                       </div> 
                                   </div>  
                                   <div class="col-md-6">                      
                                       <div class="form-group">
                                           <label> Last Name </label>
                                           <input type="text" name="last-name" class="form-control" placeholder="Enter your last name" required pattern="[A-Za-z ]+" title="Please enter a valid name">
                                       </div> 
                                   </div>    
                                   <div class="col-md-6">
                                       <div class="form-group">
                                           <label>Email </label>
                                           <input type="email" name="email" class="form-control" placeholder="Enter you email" required pattern=".+\.com$" title="Please enter a valid email ending with .com">
                                       </div>
                                   </div>
                                   <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="contact" class="form-control" placeholder="Enter your mobile number" required pattern="01\d{8,9}" maxlength="11" title="Please enter a valid phone number starting with 01 and contains 10-11 digits">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
    ...
    %>
		...
		<%
	        String emptyAddAdmin = (String) request.getAttribute("emptyAddAdmin");
	        if (emptyAddAdmin != null) {
	    %>
	    <script>
	        alert('<%= emptyAddAdmin %>');
	    </script>
	    <%
	        // Remove the attribute to prevent it from appearing again on page refresh
	        request.removeAttribute("emptyAddAdmin");
	    }
		%>
