...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <link rel="stylesheet" href="assets/css/admin-supplier-view.css"></head>
      ...
      <div class="iq-sidebar  sidebar-default ">
       ...
       <div id="modal-view" class="modal">
            <div class="modal-container-view">
                ...
                <h3>View Supplier</h3>
                <div class="modal-right-info" style="display: flex; align-items: center; justify-content: center;">
                    <span class="supplier-attribute"><b>ID:&nbsp;</b> <c:out value="${supplier.supplierId}"/></span>
                    <span class="supplier-attribute"><b>Name:&nbsp;</b> <c:out value="${supplier.supplierName}"/></span>
                    <span class="supplier-attribute"><b>Address:&nbsp;</b> <c:out value="${supplier.supplierAdd1}, ${supplier.supplierAdd2}, ${supplier.supplierPostcode}, ${supplier.supplierCity}, ${supplier.supplierState}"/></span>
                    <span class="supplier-attribute"><b>Phone No:&nbsp;</b> <c:out value="${supplier.supplierNum}"/></span>
                    <span class="supplier-attribute"><b>Email:&nbsp;</b> <c:out value="${supplier.supplierEmail}"/></span>
                </div>
                <button type="button" id="back-button" onclick="closeViewSupplier()" style="background-color: #E08DB4;">
                    Back
                    <i class="uil uil-navigator"></i>
                </button>
                <span class="close-button" onclick="closeViewSupplier()">&times;</span>
            </div>
        </div>
