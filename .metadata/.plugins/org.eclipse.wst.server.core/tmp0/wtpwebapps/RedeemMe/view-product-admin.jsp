...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <link rel="stylesheet" href="assets/css/admin-product-view.css"></head>
    ...
    <div class="wrapper">
      ...
      <div class="iq-sidebar  sidebar-default ">
       ...
       <div id="modal-view" class="modal">
            <div class="modal-container-view" style="height: auto; width: 1500px; overflow: auto;">
                <h3>View Product</h3>

                <div class="modal-left-right">
                    <div class="modal-left-image">
                        <img src="data:image/jpg/jpeg;base64,${product.productImage}" width="150px" height="130px" class="img-fluid rounded" alt="product">
                    </div>
            
                    <div class="modal-right-info">
                        <span class="product-attribute"><b>Name:&nbsp;</b> <c:out value="${product.productName}"/></span>
                        <span class="product-attribute"><b>Category:&nbsp;</b> <c:out value="${product.productCategory}"/></span>
                        <span class="product-attribute"><b>Points:&nbsp;</b> <c:out value="${product.productPoints}"/></span>
                        <span class="product-attribute"><b>Quantity:&nbsp;</b> <c:out value="${product.productQuantity}"/></span>
						<span class="product-attribute" style="text-align: left;"><b>Description:&nbsp;</b> <c:out value="${product.productDescription}"/></span>
						<span class="product-attribute"><b>Supplier:&nbsp;</b>
							<c:choose>
                ...
                <button type="button" id="back-button" onclick="closeViewProduct()" style="background-color: #E08DB4;">
                    Back
                    <i class="uil uil-navigator"></i>
                </button>
                <span class="close-button" onclick="closeViewProduct()">&times;</span>
            </div>
        </div>
