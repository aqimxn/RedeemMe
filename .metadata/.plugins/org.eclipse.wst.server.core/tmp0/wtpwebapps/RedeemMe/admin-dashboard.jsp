...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <title>Dashboard | redeemMe</title>
      ...
      <link rel="stylesheet" href="assets/css/admin-dashboard.css"></head>
    ...
    <div class="wrapper">
      ...
      <div class="content-page">
            <div class="box customer">
                <div class="big-title customer-title">
                    <h4 class="customer-desc"><a href="ListUserController">Customer</a></h4>
                </div>
                <span class="title">Total Registered Customer :</span>
                <h1><c:out value="${userCount}"/></h1>                
            </div>

            <div class="box order">
                <div class="big-title order-title">
                    <h4 class="order-desc"><a href="ListOrderController">Order</a></h4>
                </div>
                <span class="title">Total Order Received :</span>
             	<h1><c:out value="${orderCount}"/></h1>             
            </div>

            <div class="box product">
                <div class="big-title product-title">
                    <h4 class="product-desc">
                        <c:choose>
						    <c:when test="${productCount == 0 && supplierCount == 0}">
						        <a href="admin-supplier-add.jsp">Product</a>
						    </c:when>
			                <c:when test="${productCount == 0}">
			                    <a href="ViewSupplierNameController">Product</a>
			                </c:when>
			                <c:otherwise>
			                    <a href="ListProductController">Product</a>
			                </c:otherwise>
			            </c:choose>
                    </h4>
                </div>
                <span class="title">Total Product in Inventory :</span>
                 <h1><c:out value="${productCount}"/></h1>  
            </div>

            <div class="box supplier">
                <div class="big-title supplier-title">
                    <h4 class="supplier-desc">
                        <c:choose>
			                <c:when test="${supplierCount == 0}">
			                    <a href="admin-supplier-add.jsp">Supplier</a>
			                </c:when>
			                <c:otherwise>
			                    <a href="ListSupplierController">Supplier</a>
			                </c:otherwise>
			            </c:choose>
                    </h4>
                </div>
                <span class="title">Total Supplier :</span>
                <h1><c:out value="${supplierCount}"/></h1>  
            </div>
...
%>
  	...
  	<%
        String successAddAdmin = (String) request.getAttribute("successAddAdmin");
        if (successAddAdmin != null) {
    %>
    <script>
        alert('<%= successAddAdmin %>');
    </script>
    <%
        // Remove the attribute to prevent it from appearing again on page refresh
        request.removeAttribute("successAddAdmin");
    }
	%>
    </footer>
