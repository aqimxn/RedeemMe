...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <link rel="stylesheet" href="assets/css/admin-customer.css"></head>
      ...
      <div class="iq-sidebar  sidebar-default ">
       ...
       <div id="modal-update" class="modal">
            <div class="modal-container">
             ...
             <form action="UpdateUserController?userId=${user.userId}" method="POST">
                 <div class="form first">
                     <span id="modal-close" class="close" onclick="closeUpdateCustomer()">&times;</span>
                     <div class="details personal">
                         <span class="title">Edit Customer Details - <b>(( ID: <c:out value="${user.userId}"/> ))</b></span>
     
                         <div class="fields">
                             <div class="input-field">
                                 <label>Name</label>
                                 <input type="text" name="customer-name" class="form-control" value="<c:out value="${user.firstName} ${user.lastName}"/>" readonly style="cursor: not-allowed;">
                             </div>
     
                             <div class="input-field">
                                 <label>Current Points</label>
                                 <input type="text" name="customer-points" class="form-control" value="<c:out value="${user.points}"/>" readonly style="cursor: not-allowed;">
                             </div>
     
                             <div class="input-field">
                                 <label>Add Points</label>
                                 <input type="number" name="customer-add-points" min="1" required>
                             </div>
