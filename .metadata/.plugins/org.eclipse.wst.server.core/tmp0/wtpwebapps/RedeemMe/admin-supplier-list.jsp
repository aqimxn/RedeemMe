...
<html lang="en">
  ...
  <body class="  ">
               ...
               <div class="col-lg-12">
                   ...
                   <table class="data-tables table mb-0 tbl-server-info">
                       ...
                       <tr>
        					...
        					<td><c:out value="${Supplier.supplierAdd1}, ${Supplier.supplierAdd2}, ${Supplier.supplierPostcode}, ${Supplier.supplierCity}, ${Supplier.supplierState}"/></td>    
    ...
    <!-- Update Supplier -->
  	<%
        String successUpdateSupplier = (String) request.getAttribute("successUpdateSupplier");
        if (successUpdateSupplier != null) {
    %>
    <script>
        alert('<%= successUpdateSupplier %>');
    </script>
    <%
        // Remove the attribute to prevent it from appearing again on page refresh
        request.removeAttribute("successUpdateSupplier");
    }
	%>
	
		<%
	        String failUpdateSupplier = (String) request.getAttribute("failUpdateSupplier");
	        if (failUpdateSupplier != null) {
	    %>
	    <script>
	        alert('<%= failUpdateSupplier %>');
	    </script>
	    <%
	        // Remove the attribute to prevent it from appearing again on page refresh
	        request.removeAttribute("failUpdateSupplier");
	    }
		%>
		
	<!-- Delete Supplier -->
	<%
        String successDeleteSupplier = (String) request.getAttribute("successDeleteSupplier");
        if (successDeleteSupplier != null) {
    %>
    <script>
        alert('<%= successDeleteSupplier %>');
    </script>
    <%
        // Remove the attribute to prevent it from appearing again on page refresh
        request.removeAttribute("successDeleteSupplier");
    }
	%>
	
		<%
	        String failDeleteSupplier = (String) request.getAttribute("failDeleteSupplier");
	        if (failDeleteSupplier != null) {
	    %>
	    <script>
	        alert('<%= failDeleteSupplier %>');
	    </script>
	    <%
	        // Remove the attribute to prevent it from appearing again on page refresh
	        request.removeAttribute("failDeleteSupplier");
	    }
		%>
		
	<!-- Add Supplier -->
	<%
        String successAddSupplier = (String) request.getAttribute("successAddSupplier");
        if (successAddSupplier != null) {
    %>
    <script>
        alert('<%= successAddSupplier %>');
    </script>
    <%
        // Remove the attribute to prevent it from appearing again on page refresh
        request.removeAttribute("successAddSupplier");
    }
	%>
	
		<%
	        String failAddSupplier = (String) request.getAttribute("failAddSupplier");
	        if (failAddSupplier != null) {
	    %>
	    <script>
	        alert('<%= failAddSupplier %>');
	    </script>
	    <%
	        // Remove the attribute to prevent it from appearing again on page refresh
	        request.removeAttribute("failAddSupplier");
	    }
		%>
