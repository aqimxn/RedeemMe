...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <link rel="stylesheet" href="assets/css/admin-supplier-delete.css"></head>
 ...
 <div id="modal-delete" class="modal">
	<form action="DeleteSupplierController?supplierId=${supplier.supplierId}" class="modal-container-delete" method="POST">
        <div class="title-close-delete">
            Are you sure to delete <c:out value="${supplier.supplierName}"/>?
            <span id="modal-close" class="close" onclick="closeDeleteSupplier()">&times;</span>
        </div>

        <div class="submit-btn">
            <button class="btn-cancel" type="button" onclick="closeDeleteSupplier()">
                No
    ...
    <!-- Update Product -->
  	<%
        String successUpdateOrder = (String) request.getAttribute("successUpdateOrder");
        if (successUpdateOrder != null) {
    %>
    <script>
        alert('<%= successUpdateOrder %>');
    </script>
    <%
        // Remove the attribute to prevent it from appearing again on page refresh
        request.removeAttribute("successUpdateOrder");
    }
	%>
	
		<%
	        String failUpdateOrder = (String) request.getAttribute("failUpdateOrder");
	        if (failUpdateOrder != null) {
	    %>
	    <script>
	        alert('<%= failUpdateOrder %>');
	    </script>
	    <%
	        // Remove the attribute to prevent it from appearing again on page refresh
	        request.removeAttribute("failUpdateOrder");
	    }
		%>
    </footer>a
