...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <title>Add Supplier | redeemMe</title>
                               ...
                               <div class="row">
                                   <div class="col-md-12">
                                       <div class="form-group">
                                           <label>Name *</label>
                                           <input type="text" name="SupplierName" class="form-control" placeholder="Enter Supplier Name" required pattern="[A-Za-z ]+" title="Please enter a valid name">
                                       </div> 
                                   </div>  
                                   <div class="col-md-6">                      
                                       <div class="form-group">
                                           <label>Phone Number *</label>
                                           <input type="text" name="SupplierNum" class="form-control" placeholder="Enter Supplier Contact" required pattern="0\d{8,10}" maxlength="11" title="Please enter a valid phone number starting with 0 and contains 9-11 digits">
                                       </div>
                                   </div>    
                                   <div class="col-md-6">
                                       <div class="form-group">
                                           <label>Email *</label>
                                           <input type="email" name="SupplierEmail" class="form-control" placeholder="Enter Supplier Email" required pattern=".+\.com$" title="Please enter a valid email ending with .com">
                                       </div>
                                   </div>
                                   <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Address 1 *</label>
                                            <input type="text" name="SupplierAdd1" class="form-control" placeholder="Enter Supplier Address 1" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Address 2 *</label>
                                            <input type="text" name="SupplierAdd2" class="form-control" placeholder="Enter Supplier Address 2" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Postcode *</label>
                                            <input type="text" name="SupplierPostcode" class="form-control" placeholder="Enter Supplier Postcode" required pattern="\d{5}" maxlength="5" title="Please enter a valid postcode that contains exactly 5 digits">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>City *</label>
                                            <input type="text" name="SupplierCity" class="form-control" placeholder="Enter Supplier City" required pattern="[A-Za-z ]+" title="Please enter a valid city">
                                        </div>
                                    </div>
                                   <div class="col-md-12">
                                       <div class="form-group">
                                           <label for="state">State *</label>
                                            <select id="state" name="SupplierState" class="form-control" required>
                                                <option disabled selected value="">Select Supplier State</option>
