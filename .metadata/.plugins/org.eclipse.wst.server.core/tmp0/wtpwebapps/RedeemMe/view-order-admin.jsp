        ...
        <div class="modal-container-view">
            <span id="modal-close" class="close-button" onclick="closeViewOrder()">&times;</span>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                        	<td><img src="data:image/jpg;base64,${order.productImage}" width="100px" class="img-fluid rounded" alt="product"></td>
                            <td><c:out value="${order.productName}"/></td>
                            <td>1</td>
                            <td><c:out value="${order.productPoints}"/></td>
                        </tr>
                    </tbody>
                </table>
                <br><p style="text-align: end;"><strong>Total Points Used:</strong>&nbsp;<c:out value="${order.productPoints}"/></p>
