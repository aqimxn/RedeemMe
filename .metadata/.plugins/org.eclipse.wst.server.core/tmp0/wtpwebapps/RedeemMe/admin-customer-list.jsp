...
<html lang="en">
  ...
  <body class="  ">
    ...
    <footer class="iq-footer">
  	...
  	<%
        String successUpdate = (String) request.getAttribute("successUpdate");
    ...
    <%
        ...
        request.removeAttribute("successUpdate");
    }
	%>
	
	
  	<%
        String failUpdate = (String) request.getAttribute("failUpdate");
        if (failUpdate != null) {
    %>
    <script>
        alert('<%= failUpdate %>');
    ...
    <%
        // Remove the attribute to prevent it from appearing again on page refresh
        request.removeAttribute("failUpdate");
    }
	%>
