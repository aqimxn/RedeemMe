...
<html lang="en">
  <head>
    <meta charset="utf-8">
      ...
      <title>Customer List | redeemMe</title>
      ...
      <link rel="stylesheet" href="assets/css/admin-customer-view.css"></head>
                   ...
                   <table class="data-tables table mb-0 tbl-server-info">
                       ...
                       <c:forEach items="${users}" var="User" varStatus="users">
                           <tr>
                               ...
                               <td><img src="data:image/jpg;base64,${User.picture}" width="100px" height="100px" /></td>
                               <td><c:out value="${User.firstName} ${User.lastName}"/></td>
                               <td><c:out value="${User.address1}, ${User.address2}, ${User.postcode}, ${User.city}, ${User.state}"/></td>
                               <td><c:out value="${User.mobile}"/></td>
                               <td><c:out value="${User.email}"/></td> 
                               <td><c:out value="${User.points}"/></td>
                               <td>
                                   <div class="d-flex align-items-center list-action">
                                       <a href="ViewUserController?userId=${User.userId}" class="badge badge-info mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="View"
                                           ><i class="ri-eye-line mr-0"></i></a>
                                       <a href="ToUpdateUser?userId=${User.userId}" class="badge bg-success mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"
       ...
       <div id="modal-view" class="modal">
            <div class="modal-container-view">
                ...
                <div class="modal-left-right">
                	...
                	<div class="modal-right-picture" style="display: flex; align-items: center; justify-content: center;">
                	   	<img src="data:image/jpg;base64,${user.picture}" width="200px" height="200px" />
                	</div>
                    ...
                    <div class="modal-right-info">
                        ...
                        <span class="customer-attribute"><b>Address:&nbsp;</b><c:out value="${user.address1}, ${user.address2}, ${user.postcode}, ${user.city}, ${user.state}"/></span>
                        <span class="customer-attribute"><b>Mobile:&nbsp;</b><c:out value="${user.mobile}"/></span>
                ...
                <button type="button" id="back-button" onclick="closeViewCustomer()" style="background-color: #E08DB4;">
                    Back
                    <i class="uil uil-navigator"></i>
                </button>
                <span class="close-button" onclick="closeViewCustomer()">&times;</span>
            </div>
        </div>
