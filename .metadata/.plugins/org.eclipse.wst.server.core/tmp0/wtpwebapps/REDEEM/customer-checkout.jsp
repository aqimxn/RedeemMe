...
<!-- Starts here -->
	...
	<div class="container">
        <div class="checkoutLayout">
            <div class="left">
			<form action="CheckOutCustomerController?productId=${product.productId}" method="Post">
			    <h1>List Product</h1>
			    <div class="form">
			        <div class="group">
			        ...
			        <div class="group">
			            ...
			            <input type="text" name="Name" id="productName" class="form-control" value="${product.productName}" readonly>
			        </div>
			        <div class="group">
			            <label for="Category">Product Category</label>
			            <input type="text" name="category" id="productCategory" class="form-control" value="${product.productCategory}" readonly>
			        </div>
			        <div class="group">
			            <label for="description">Product Description</label>
			            <input type="text" name="description" id="productDescription" class="form-control" value="${product.productDescription}" readonly>
			        </div>
			    </div>
			</form>
            </div>
        ...
        <div class="right">
        <form action="CheckOutCustomerController?userId=${user.userId}" method="POST">
            <div class="form">
    ...
    <a class="buttonCheckout" style="justify-self: center;" href = "customer-receipt.jsp">CHECKOUT</a>
    </form>
</div>
<!-- Ends -->
         </div>
