           ...
           <div class="row">
               <div class="col-sm-12">
                   <div class="card">
                       ...
                       <div class="card-body">
                           <form action="AddSupplierController" data-toggle="validator" method="post">
                               <div class="row">
                                   <div class="col-md-12">
                                       <div class="form-group">
                                           <label>Name *</label>
                                           <input type="text" name="SupplierName" class="form-control" placeholder="Enter Supplier Name" data-errors="Please Enter Name." required>
                                   ...
                                   <div class="col-md-6">                      
                                       <div class="form-group">
                                           ...
                                           <input type="number" name="SupplierNum" class="form-control" placeholder="Enter Supplier Contact" data-errors="Please Enter Contact." min="1" required>
                                           <div class="help-block with-errors"></div>
                                       </div>
                                   </div>    
                                   <div class="col-md-6">
                                       <div class="form-group">
                                           <label>Email *</label>
                                           <input type="text" name="SupplierEmail" class="form-control" placeholder="Enter Supplier Email" data-errors="Please Enter Email." required>
                                           <div class="help-block with-errors"></div>
                                       </div>
                                   </div>
                                   <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="SupplierAdd1" class="form-control" placeholder="Enter Supplier Address 1" data-errors="Please Enter Email." required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="SupplierAdd2" class="form-control" placeholder="Enter Supplier Address 2" data-errors="Please Enter Email." required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="SupplierPostcode" class="form-control" placeholder="Enter Supplier Postcode" data-errors="Please Enter Email." required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>City *</label>
                                            <input type="text" name="SupplierCity" class="form-control" placeholder="Enter Supplier City" data-errors="Please Enter Email." required>
                                            <div class="help-block with-errors"></div>
                                        </div>
                                    </div>
                                   <div class="col-md-12">
