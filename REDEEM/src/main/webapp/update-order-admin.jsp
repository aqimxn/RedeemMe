    ...
    <div class="wrapper">
      ...
      <div class="iq-sidebar  sidebar-default ">
       ...
       <!-- Modal Edit -->
           ...
           <!-- Modal Update -->
            <div id="modal-update" data-current-status="<c:out value='${order.shipmentStatus}'/>">
                <div class="modal-container-update">
                    ...
                    <h2>Update Shipment Status</h2>
                        ...
                        <form action="UpdateOrderController?orderId=${order.orderId}" id="statusForm" method="POST">
                            <label for="status">Shipment Status:</label>
				 			<select id="status" name="shipment-status" required>
