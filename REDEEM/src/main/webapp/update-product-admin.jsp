    ...
    <div class="wrapper">
      ...
      <div class="iq-sidebar  sidebar-default ">
       ...
       <div id="modal-update" class="modal">
        ...
        <form action="UpdateProductController?productId=${product.productId}" method="POST">
                ...
                <div class="details personal">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="number" min="50" name="productPoints" value="<c:out value="${product.productPoints}"/>" required>
                        </div>
						...
						<%-- Use the set variable in the input field --%>
						<div class="input-field">
                        ...
                        <div class="input-field">
                            ...
                            <input type="file" id="image" name="productImage" accept="image/jpeg, image/png" value="get from db">
                        </div>
                    </div>
                </div>
