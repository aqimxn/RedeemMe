           ...
           <div class="row">
               <div class="col-sm-12">
                   <div class="card">
                       ...
                       <div class="card-body">
                           <form action="AddProductController" method="post" data-toggle="validator">
                               <div class="row">
                                   <div class="col-md-12">
                                   ...
                                   <div class="col-md-6">                      
                                       <div class="form-group">
                                           <label>Name *</label>
                                           <input type="text" name="ProductName" class="form-control" placeholder="Enter Product Name" data-errors="Please Enter Name." required>
                                           <div class="help-block with-errors"></div>
                                       </div>
                                   </div>    
                                   <div class="col-md-6">
                                       <div class="form-group">
                                           ...
                                           <input type="text" name="ProductCategory" class="form-control" placeholder="Enter Product Category" data-errors="Please Enter Category." required>
                                           <div class="help-block with-errors"></div>
                                       </div>
                                   </div> 
                                   <div class="col-md-6"> 
                                       <div class="form-group">
                                           ...
                                           <input type="number" min="50" name="ProductPoints" class="form-control" placeholder="Enter Product Points" data-errors="Please Enter Points." required>
                                           <div class="help-block with-errors"></div>
                                       </div>
                                   </div> 
                                   <div class="col-md-6">
                                   ...
                                   <div class="col-md-12">
                                       <div class="form-group">
                                           <label>Image</label>
                                           <input type="file" name="ProductImage" class="form-control image-file" accept="image/*" style="border: none;">
                                       </div>
                                   </div>
                                   <div class="col-md-12">
                                       <div class="form-group">
