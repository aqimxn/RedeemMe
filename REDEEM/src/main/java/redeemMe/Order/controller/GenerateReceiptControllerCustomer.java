...
/**
 * Servlet implementation class GenerateReceiptControllerCustomer1
 */
public class GenerateReceiptControllerCustomer extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GenerateReceiptControllerCustomer() {
        super();
	 ...
	 */
		protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			try {
	            ...
	            if (session != null) {
	            System.out.println("Pass To GenerateReceiptCustomer");
					...
					request.setAttribute("orders", OrderDAO.getOrder(OrderId));
					request.setAttribute("productPoints", UserDAO.getUser(productPoints));
					
					RequestDispatcher req = request.getRequestDispatcher("customer-receipt.jsp");
