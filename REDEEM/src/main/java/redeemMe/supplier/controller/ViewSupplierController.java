...
public class ViewSupplierController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//set attribute to a servlet request. Set the attribute name to shawls and call getSupplier() from SupplierDAO class
		...
		//Obtain the RequestDispatcher from the request object. The pathname to the resource is admin-supplier-list.jsp.jsp
		RequestDispatcher req = request.getRequestDispatcher("view-supplier-admin.jsp");
